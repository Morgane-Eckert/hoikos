...
<html>
	...
	<body>
		...
		<nav>
            <a href="index.php" class="actuel">Home</a>
            <a href="index.php" class="Onglet">Chambre</a>
            <a href="index.php" class="Onglet_alerte">Salon</a>
            <a href="index.php" class="Onglet">+</a>
            <a href="index.php" class="Conso">Consommations</a>
